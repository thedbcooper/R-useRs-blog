...
description: "A deep dive into R packages"
...
You will see me mostly using tidyverse packages because I value their human readability, consistent structure, and stability of included functions. "Stability" harkens to the "[lifecycle](https://lifecycle.r-lib.org/articles/stages.html#superseded)" of a package or function. Perhaps you're still concerned with sustainability and "dependency-bloat," so you stick with base R. Maybe you need functions that perform better, so you use the [{data.table}](Extension%20of%20%60data.frame%60%20•%20data.table) package, another R "dialect." Maybe you just prefer to use whichever functions require the least amount of code. There are other reasons you will come across that lead you to choose when and where to use a specific function.
